		...
		<>
				...
				<div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">	
					<div className="space-y-8 relative z-10">
						<div className="inline-block px-4 py-1.5 bg-primary/10 rounded-full">
							<span className="text-xs font-black uppercase tracking-widest text-primary">Est. 2026</span>
						</div>
						<h1 className="text-7xl md:text-8xl font-light tracking-tighter text-neutral leading-[0.9]">
							Elevate your <br />
							<span className="font-bold text-primary italic">culinary nest.</span>
						</h1>
						<p className="text-xl text-neutral/60 max-w-md leading-relaxed">
							A refined community for chefs to document, share, and discover world-class techniques and recipes.
						</p>
						<div className="flex items-center space-x-4 pt-4">
							<Link to="/recipes" className="bg-primary text-white px-10 py-4 rounded-full font-bold shadow-xl shadow-primary/20 hover:scale-105 transition-all">
								Explore Recipes
							</Link>
			...
			<section className="px-12 py-24 bg-primary rounded-t-[5rem] shadow-[0_-30px_60px_-15px_rgba(0,0,0,0.05)]">
				...
				<div className="flex justify-between items-end mb-16">
					...
					<h2 className="text-xs font-black uppercase tracking-[0.3em] text-secondary">Curated Selection</h2>
					<p className="text-5xl font-bold text-secondary">Trending Now</p>
					</div>
				</div>
			...
			<section className="px-12 py-32 bg-neutral text-secondary text-center">
				...
				<p className="text-secondary/40">Get weekly deep-dives into sourcing, plating, and molecular gastronomy.</p>
				</div>
			</section>
			</div>
		</>
