			...
			<form onSubmit={handleSubmit(onSubmit)} 
				...
				<div>
					<label>Password
						...
						<br />
						{errors.password && (
							<span className='error-message text-red-600'>{errors.password.message}</span>
						)}
					</label>
				</div>
				{/* Passowrd Field End */}
				...
				<div>
					<label>Confirm Password
						...
						{errors.confirmPassword && (
							<span className='error-message text-red-500'>{errors.confirmPassword.message}</span>
						)}
					</label>
				</div>
				{/* Passowrd Field End */}
				...
				<div>
					<label>
						...
						I agree with to &nbsp;<NavLink to="/terms-of-service" className='text-primary'>Terms of Service</NavLink>
						<br />
						{errors.terms && (
							<span className='error-message text-red-500'>{errors.terms.message}</span>
						)}
					</label>
				</div>

				{/* Submit Button */}
				<input type="submit" value="Submit" className="text-secondary bg-primary w-full h-10 px-4 py-1 cursor-pointer hover:bg-neutral/75" />
			</form>
