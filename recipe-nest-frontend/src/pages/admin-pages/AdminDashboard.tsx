...
import type { Recipe } from "../../components/AdminRecipeListItem";
    ...
    <div className="min-h-screen bg-secondary p-8 md:p-12">
      <header className="flex justify-between items-end mb-12">
        ...
        <div className="text-right">
          <p className="text-[10px] font-bold text-neutral/40 uppercase">
            Last Sync
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        {[
          ...
          <div
            key={i}
            className="bg-white p-8 rounded-4xl shadow-sm border border-border"
          >
            <p className="text-[10px] font-black uppercase tracking-widest text-neutral/30 mb-2">
              {stat.label}
            </p>
      ...
      <div className="bg-white rounded-[3rem] overflow-hidden border border-border shadow-sm">
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-border">
            {stats.recentRecipes.map((recipe: Recipe) => (
              <AdminRecipeListItem
                key={recipe._id}
                recipe={recipe}
