...
function AdminRecipeListItem({ recipe, handleToggleFlag, flagMutation }) {
	return (
		<tr
			key={recipe._id}
		...
		>
			<td className="px-8 py-6">
				...
				<p className="text-[10px] text-neutral/40 uppercase font-black">
					{recipe.chef.name}
				</p>
			</td>
			<td className="px-8 py-6">
			...
			<td className="px-8 py-6 text-right">
				...
				>
					...
					flagMutation.variables?.id === recipe._id
						? "Updating..."
						: recipe.flagged
							? "Unflag"
							: "Flag Entry"}
...
export default AdminRecipeListItem;
